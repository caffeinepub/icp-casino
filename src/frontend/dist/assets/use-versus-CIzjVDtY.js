import { K as PlayerStatus, j as jsxRuntimeExports, S as Skeleton, g as formatICP, z as WagerAmount, i as useQuery, b as useQueryClient, f as useMutation, r as reactExports, a as useActor, u as useAuth, h as createActor } from "./index-7NfWNnFD.js";
...
function resolveUsername(player) {
  if (player.username && player.username.length > 0)
    return player.username[0] ?? `Player_${player.id.toText().replace(/-/g, "").slice(-6).toUpperCase()}`;
