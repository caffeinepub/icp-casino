import { c as createLucideIcon, u as useAuth, A as useMyProfile, D as getDisplayName, E as getAvatarUrl, r as reactExports, j as jsxRuntimeExports, B as Button, M as Send, J as isEmojiAvatar, N as MatchStatus, V as VersusGameType, F as isFlagAvatar, H as FlagIcon, S as Skeleton, W as Wallet } from "./index-DbaSLhFP.js";
import { e as useSendChatMessage, f as formatTimestamp, g as useAcceptWager, w as wagerToICP$1, h as useMatch, i as useMatchChat, u as useOnlinePlayers, j as useLeaveMatch, k as useMakeChessMove, d as useHeartbeat, O as OnlinePlayersList, W as WagerSelector, l as useMakeDiceRoll, m as useMakeRPSChoice } from "./use-versus-DYxuWbNt.js";
import { T as Trophy } from "./trophy-XeKuy5-B.js";
import { A as ArrowLeft } from "./arrow-left-D2cTDWMw.js";
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            "aria-hidden": "true",
            children: avatarUrl && isFlagAvatar(avatarUrl) ? /* @__PURE__ */ jsxRuntimeExports.jsx(FlagIcon, { code: avatarUrl, size: 42 }) : avatarUrl && isEmojiAvatar(avatarUrl) ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 17, lineHeight: 1 }, children: avatarUrl }) : avatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: avatarUrl, alt: name }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color }, children: initial })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    "aria-hidden": "true",
                    children: myAvatarUrl && isFlagAvatar(myAvatarUrl) ? /* @__PURE__ */ jsxRuntimeExports.jsx(FlagIcon, { code: myAvatarUrl, size: 30 }) : myAvatarUrl && isEmojiAvatar(myAvatarUrl) ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 13, lineHeight: 1 }, children: myAvatarUrl }) : myAvatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: myAvatarUrl, alt: myDisplayName }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.65 0.25 265)" }, children: myDisplayName.slice(0, 1).toUpperCase() })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
