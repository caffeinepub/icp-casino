import { c as createLucideIcon, j as jsxRuntimeExports, G as GameCategory, B as Button, S as Skeleton, r as reactExports, a as useActor, b as useQueryClient, d as useWallet, e as useIcpWallet, f as useMutation, g as formatICP, W as Wallet, h as createActor, i as useQuery, I as Input } from "./index-l8klBg70.js";
import { g as getGameImage, i as isPicsumUrl, T as TrendingUp } from "./gameImages-DRMLZYcs.js";
import { U as Users } from "./users-DshArV-p.js";
          ...
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-2 right-2 flex items-center gap-1 bg-background/80 backdrop-blur-sm rounded-full px-2 py-0.5 border border-border", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-medium font-mono", children: Number(game.playerCount).toLocaleString() })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "heading-cinematic text-sm truncate mb-0.5 min-w-0", children: game.name }),
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col justify-end p-6 md:p-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "heading-cinematic text-2xl md:text-4xl lg:text-5xl mb-2 leading-tight max-w-lg", children: game.name }),
        ...
        count > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 right-6 flex items-center gap-1.5", children: games.map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `h-2 rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring ${i === current ? "w-5" : "w-2 hover:opacity-80"}`,
              style: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        borderRadius: 8,
        boxShadow: isWinning ? "0 0 20px oklch(0.72 0.18 65 / 0.7), 0 0 40px oklch(0.72 0.18 65 / 0.35), inset 0 0 10px oklch(0.72 0.18 65 / 0.25)" : isSpinning ? "none" : "inset 0 1px 0 oklch(1 0 0 / 0.04), inset 0 -1px 0 oklch(0 0 0 / 0.3)",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              background: isConnecting ? "rgba(212,175,55,0.4)" : "linear-gradient(135deg, #e8c96a 0%, #D4AF37 40%, #a07830 100%)",
              color: "#1a0d3a",
              boxShadow: isConnecting ? "none" : "0 4px 24px rgba(212,175,55,0.55), 0 2px 0 rgba(140,100,20,0.6), inset 0 1px 0 rgba(255,230,120,0.35)"
            },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-5xl", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                style: {
                  ...
                  background: "linear-gradient(135deg, #4a7ae8 0%, #8aadff 30%, #D4AF37 65%, #e8c76a 100%)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                boxShadow: "0 0 40px oklch(0.45 0.25 240 / 0.5), 0 0 80px oklch(0.72 0.18 65 / 0.15)"
              },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cinematic-top-light" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: BET_OPTIONS_ICP.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "button",
                            {
                              ...
                              style: {
                                ...
                                boxShadow: betIcp === b ? "0 0 14px rgba(212,175,55,0.45), inset 0 1px 0 rgba(255,220,100,0.2)" : "inset 0 1px 0 rgba(255,255,255,0.04)",
                          ...
                          outcome.status === "won" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              ...
                              style: {
                                ...
                                color: "#D4AF37",
                                boxShadow: "0 0 20px rgba(212,175,55,0.4), inset 0 1px 0 rgba(255,220,100,0.2)"
                              },
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            ...
                            style: {
                              letterSpacing: "0.18em",
                              background: isSpinning ? "rgba(212,175,55,0.25)" : "linear-gradient(135deg, #e8c76a 0%, #D4AF37 35%, #c0980e 65%, #a07830 100%)",
                              color: "#1a0740",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-3", children: Object.entries(MULTIPLIERS).map(([count, mult]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 container mx-auto px-4 py-10 space-y-16", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "games", "aria-label": "Game lobby", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "heading-cinematic font-display text-3xl font-bold text-foreground", children: "Game Lobby" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8 max-w-sm", "data-ocid": "game-search", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Search,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  onFocus: (e) => {
                    e.currentTarget.style.borderColor = "oklch(0.72 0.18 65 / 0.70)";
                    e.currentTarget.style.boxShadow = "0 0 0 1px oklch(0.72 0.18 65 / 0.25)";
                  },
                  onBlur: (e) => {
            ...
            isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5", children: Array.from({ length: 10 }, (_, i) => `skel-${i}`).map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonCard, { variant: "game" }, key)) }) : filteredGames.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      style: {
                        background: "linear-gradient(135deg, oklch(0.72 0.18 65 / 0.18), oklch(0.60 0.18 65 / 0.10))",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      color: "oklch(0.07 0 0)",
                      boxShadow: "0 4px 16px oklch(0.72 0.18 65 / 0.35)"
                    },
                    children: "Play Now →"
                  }
                )
            ...
            "section",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "heading-cinematic font-display text-2xl font-bold text-foreground", children: "Midnight Dragons" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: "text-xs font-semibold px-2.5 py-1 rounded-full uppercase tracking-wider",
