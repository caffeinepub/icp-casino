import { c as createLucideIcon, u as useAuth, r as reactExports, j as jsxRuntimeExports, B as Button, E as Send, M as MatchStatus, V as VersusGameType, S as Skeleton, W as Wallet } from "./index-CHITFDq0.js";
import { e as useSendChatMessage, f as formatTimestamp, g as useAcceptWager, w as wagerToICP$1, h as useMatch, i as useMatchChat, u as useOnlinePlayers, j as useLeaveMatch, k as useMakeChessMove, d as useHeartbeat, O as OnlinePlayersList, W as WagerSelector, l as useMakeDiceRoll, m as useMakeRPSChoice } from "./use-versus-C0iW6nUa.js";
import { T as Trophy } from "./trophy-eLwWiQaR.js";
import { A as ArrowLeft } from "./arrow-left-C37eBoze.js";
import "./users-DLmbjCao.js";
/**
...
function LiveChat({ matchId, messages, opponentName }) {
      ...
      "div",
      {
        ...
        children: [
          ...
          messages.map((msg, i) => {
            ...
            const senderLabel = isMe ? "You" : opponentName ?? `${msg.senderId.toText().slice(0, 8)}…`;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "versus-chat-message mb-3",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between mb-1 gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: isMe ? "versus-chat-message-player" : "versus-chat-message-opponent",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "oklch(0.50 0.03 65)" }, children: [
              "Wager: ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(WagerLabel, { wager: match.wager })
            ] })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "oklch(0.68 0.03 65)" }, children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "oklch(0.50 0.03 65)" }, children: [
            "Pot: ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(WagerLabel, { wager: match.wager }),
            " × 2"
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "p",
          {
            ...
            children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.60 0.03 65)" }, children: "Plug Wallet is required for real ICP betting." })
            ]
          }
        )
      ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        boxShadow: "0 0 28px oklch(0.72 0.18 65 / 0.18), 0 0 8px oklch(0.72 0.18 65 / 0.1)"
      },
                ...
                (rank) => FILES.map((file) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      style: {
                        background: isSelected ? "oklch(0.72 0.18 65 / 0.45)" : isLight ? "oklch(0.22 0.03 65 / 0.6)" : "oklch(0.12 0.01 45)",
                      ...
                      children: piece ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          style: {
                            color: piece === piece.toUpperCase() ? "oklch(0.82 0.18 65)" : "oklch(0.45 0.15 300)",
                            textShadow: piece === piece.toUpperCase() ? "0 1px 4px oklch(0 0 0 / 0.6)" : "0 1px 4px oklch(0 0 0 / 0.6)",
                            lineHeight: 1
                          },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: (diceState == null ? void 0 : diceState.player1Roll) != null ? String(diceState.player1Roll) : "?"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-2", style: { color: "oklch(0.50 0.03 65)" }, children: "Player 1" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: (diceState == null ? void 0 : diceState.player2Roll) != null ? String(diceState.player2Roll) : "?"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-2", style: { color: "oklch(0.50 0.03 65)" }, children: "Player 2" })
          ] })
        ] }),
...
function RPSGame({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "rps-game",
      children: [
        (rpsState == null ? void 0 : rpsState.player1Choice) || (rpsState == null ? void 0 : rpsState.player2Choice) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-8 text-5xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: ((_a = RPS_CHOICES.find((c) => c.value === rpsState.player1Choice)) == null ? void 0 : _a.emoji) ?? "🤔" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-xs mt-2",
                style: { color: "oklch(0.50 0.03 65)" },
                children: rpsState.player1Choice ?? "Choosing…"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: ((_b = RPS_CHOICES.find((c) => c.value === rpsState.player2Choice)) == null ? void 0 : _b.emoji) ?? "🤔" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-xs mt-2",
                style: { color: "oklch(0.50 0.03 65)" },
                children: rpsState.player2Choice ?? "Choosing…"
              }
            )
          ] })
        ] }) : null,
        ...
        myChoice && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "oklch(0.55 0.03 65)" }, children: [
          "You chose ",
          myChoice,
...
function VersusMatch({ matchId, onBack }) {
  ...
  if (!match) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-96 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "oklch(0.55 0.03 65)" }, children: "Match not found." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: onBack, variant: "outline", "data-ocid": "back-btn", children: "Back to Lobby" })
    ] });
  }
  const myId = principalText;
  ...
  const opponentName = opponentPlayer ? `${opponentPlayer.id.toText().slice(0, 8)}…` : "Opponent";
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-xs font-mono", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.72 0.18 65)" }, children: "You" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.40 0.02 65)" }, children: "vs" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.72 0.15 300)" }, children: opponentName })
                    ] })
                  ]
                }
              ),
