import { r as reactExports, j as jsxRuntimeExports, u as useAuth, V as VersusGameType, z as WagerAmount, B as Button, S as Skeleton, W as Wallet, A as useMyProfile, D as getDisplayName, E as getAvatarUrl, F as isFlagAvatar, H as FlagIcon, J as isEmojiAvatar } from "./index-DbaSLhFP.js";
import { B as Badge } from "./badge-C9H4ej2b.js";
import { u as useOnlinePlayers, a as useOpenMatches, b as useCreateMatch, c as useJoinMatch, d as useHeartbeat, W as WagerSelector, O as OnlinePlayersList } from "./use-versus-DYxuWbNt.js";
import "./users-Cral2wSP.js";
...
function GameCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      style: {
        borderColor: selected ? "oklch(0.72 0.18 65 / 0.70)" : "oklch(0.4 0.15 300 / 0.30)",
        boxShadow: selected ? "0 0 28px oklch(0.72 0.18 65 / 0.25), var(--shadow-md)" : "none",
        transform: selected ? "translateY(-2px)" : void 0
      },
      "data-ocid": `game-select-${type.toLowerCase()}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-3", children: emoji }),
...
function OpenMatchRow({
  ...
  var _a;
  const gameLabel = ((_a = GAME_OPTIONS.find((g) => g.type === match.gameType)) == null ? void 0 : _a.label) ?? match.gameType;
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    children: "Plug Wallet"
                  }
                ),
                " ",
                "to connect and play Versus Mode. Plug Wallet is required for real ICP betting."
              ]
            }
          )
        ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "oklch(0.50 0.03 65)" }, children: "— real ICP bets only" })
      ]
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            "aria-hidden": "true",
            children: avatarUrl && isFlagAvatar(avatarUrl) ? /* @__PURE__ */ jsxRuntimeExports.jsx(FlagIcon, { code: avatarUrl, size: 42 }) : avatarUrl && isEmojiAvatar(avatarUrl) ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 17, lineHeight: 1 }, children: avatarUrl }) : avatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: avatarUrl, alt: displayName }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.65 0.25 265)" }, children: initial })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
...
function VersusLobby({ onMatchStart }) {
  const { isAuthenticated } = useAuth();
  const [gameType, setGameType] = reactExports.useState(
    VersusGameType.Chess
  );
  const [wager, setWager] = reactExports.useState(WagerAmount.Ten);
  const { data: onlinePlayers = [], isLoading: playersLoading } = useOnlinePlayers();
  const { data: openMatches = [], isLoading: matchesLoading } = useOpenMatches();
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(PlugWalletFullBanner, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-sm text-center",
              style: { color: "oklch(0.45 0.03 65)" },
              children: "Connect your wallet above to access Versus Mode and start competing for real ICP."
            }
          )
        ]
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: "radial-gradient(ellipse at 50% 0%, oklch(0.13 0.03 300 / 0.45) 0%, oklch(0.07 0 0) 65%)"
      },
      "data-ocid": "versus-lobby",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-6 py-8 space-y-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "space-y-4",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-1 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "svg",
                    {
                      width: "32",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MyIdentityBadge, {}) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Challenge real players. Agree on a wager. Winner takes all."
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(PlugWalletInfoStrip, {})
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.section,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: GAME_OPTIONS.map(({ type, label, emoji, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    GameCard,
                    {
                      type,
                      label,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(WagerSelector, { selected: wager, onChange: setWager }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "text-xs mt-2",
                      style: { color: "oklch(0.45 0.03 65)" },
                      children: "Real ICP deducted from your Plug Wallet — winner takes both wagers."
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: isCreating ? "Creating Match…" : "Create Match & Wait for Opponent"
                  }
                )
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.section,
            {
              ...
              children: [
                ...
                matchesLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [1, 2].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full rounded-xl" }, n)) }) : openMatches.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "oklch(0.45 0.03 65)" }, children: "No open matches. Create one and wait for a challenger!" })
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: openMatches.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  OpenMatchRow,
                  {
                    match: m,
                    onJoin: handleJoin,
