import { a as useActor, b as useQueryClient, d as useWallet, e as useIcpWallet, r as reactExports, f as useMutation, j as jsxRuntimeExports, C as Coins, S as Skeleton, g as formatICP, W as Wallet, h as createActor } from "./index-l8klBg70.js";
import { A as ArrowLeft } from "./arrow-left-CQ_UYCyb.js";
import { S as Sparkles } from "./sparkles-HNwJ5Uan.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        boxShadow: isWin ? "0 0 32px 8px rgba(212,175,55,0.65), 0 0 60px rgba(212,175,55,0.3), inset 0 2px 4px rgba(255,220,100,0.2), inset 0 -2px 4px rgba(80,20,100,0.4)" : spinning ? "0 0 14px 3px rgba(123,47,190,0.55), inset 0 2px 4px rgba(180,130,255,0.1)" : "inset 0 2px 8px rgba(0,0,0,0.7), inset 0 -2px 4px rgba(80,20,100,0.35), 0 2px 6px rgba(0,0,0,0.5)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              ...
              color: "#1a0740",
              boxShadow: isConnecting ? "none" : "0 4px 24px rgba(212,175,55,0.55), 0 2px 0 rgba(160,120,48,0.8), inset 0 1px 0 rgba(255,230,120,0.4)"
            },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 mb-5 text-center px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
              ...
              style: {
                ...
                background: "linear-gradient(135deg, #e8c76a 0%, #D4AF37 45%, #f0d070 60%, #a07830 100%)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: "0 0 16px rgba(212,175,55,0.2), inset 0 1px 0 rgba(255,220,100,0.15)"
            },
            children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    ...
                    boxShadow: "inset 0 4px 16px rgba(0,0,0,0.8), inset 0 -2px 8px rgba(60,20,100,0.3)"
                  },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-16 flex items-center justify-center mb-6", children: [
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      style: {
                        ...
                        boxShadow: isActive ? "0 0 16px rgba(212,175,55,0.45), inset 0 1px 0 rgba(255,220,100,0.2)" : "inset 0 1px 0 rgba(255,255,255,0.04)",
              ...
              outcome.status === "idle" || isSpinning ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    fontSize: "1.2rem",
                    letterSpacing: "0.22em",
                    background: isSpinning ? "rgba(212,175,55,0.3)" : "linear-gradient(135deg, #e8c76a 0%, #D4AF37 30%, #c8a030 65%, #a07830 100%)",
                    color: "#1a0740",
                ...
                "button",
                {
                  ...
                  style: {
                    ...
                    boxShadow: "0 0 16px rgba(212,175,55,0.3), inset 0 1px 0 rgba(255,220,100,0.15)",
                    cursor: "pointer"
                  },
                  children: "↻ Play Again"
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "linear-gradient(90deg, transparent, rgba(123,47,190,0.6), rgba(212,175,55,0.3), rgba(123,47,190,0.6), transparent)"
                  }
                }
              )
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2 text-xs text-center", children: BET_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
