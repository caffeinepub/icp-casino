import { r as reactExports, j as jsxRuntimeExports, u as useAuth, V as VersusGameType, z as WagerAmount, B as Button, S as Skeleton, W as Wallet } from "./index-CHITFDq0.js";
import { B as Badge } from "./badge-DEtrlsFS.js";
import { u as useOnlinePlayers, a as useOpenMatches, b as useCreateMatch, c as useJoinMatch, d as useHeartbeat, W as WagerSelector, O as OnlinePlayersList } from "./use-versus-C0iW6nUa.js";
...
function GameCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      style: {
        background: selected ? "oklch(0.72 0.18 65 / 0.12)" : "oklch(0.11 0.01 45)",
        borderColor: selected ? "oklch(0.72 0.18 65 / 0.7)" : "oklch(0.25 0.05 65 / 0.4)",
...
function VersusLobby({ onMatchStart }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-[calc(100vh-4rem)]", "data-ocid": "versus-lobby", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "oklch(0.55 0.03 65)" }, children: "Challenge real players. Agree on a wager. Winner takes all." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.section,
        {
          ...
          children: [
            ...
            matchesLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [1, 2].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full rounded-lg" }, n)) }) : openMatches.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
