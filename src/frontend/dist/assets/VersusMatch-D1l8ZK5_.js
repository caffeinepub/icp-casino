import { c as createLucideIcon, u as useAuth, r as reactExports, j as jsxRuntimeExports, B as Button, E as Send, M as MatchStatus, V as VersusGameType, S as Skeleton, W as Wallet } from "./index-lnEvHqvE.js";
import { e as useSendChatMessage, f as formatTimestamp, g as useAcceptWager, w as wagerToICP$1, h as useMatch, i as useMatchChat, u as useOnlinePlayers, j as useLeaveMatch, k as useMakeChessMove, d as useHeartbeat, O as OnlinePlayersList, W as WagerSelector, l as useMakeDiceRoll, m as useMakeRPSChoice } from "./use-versus-PvkDe-6O.js";
import { T as Trophy } from "./trophy-dMynM-LP.js";
import { A as ArrowLeft } from "./arrow-left-C0SkUMHW.js";
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: piece ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          style: {
                            color: piece === piece.toUpperCase() ? "oklch(0.88 0.18 65)" : "oklch(0.50 0.18 300)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(135deg, oklch(0.14 0.02 65 / 0.80), oklch(0.10 0.01 45))",
                  borderColor: "oklch(0.72 0.18 65 / 0.55)",
                  color: "oklch(0.88 0.18 65)",
                  boxShadow: "0 0 20px oklch(0.72 0.18 65 / 0.20), var(--shadow-md)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "w-24 h-24 rounded-2xl flex items-center justify-center text-4xl font-mono font-black border-2 card-shimmer",
                style: {
                  background: "linear-gradient(135deg, oklch(0.14 0.04 300 / 0.60), oklch(0.10 0.02 300 / 0.50))",
                  borderColor: "oklch(0.45 0.15 300 / 0.55)",
                  color: "oklch(0.78 0.15 300)",
                  boxShadow: "0 0 20px oklch(0.45 0.15 300 / 0.20), var(--shadow-md)"
                },
      ...
      children: [
        ...
        canPlay && !myChoice && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4", children: RPS_CHOICES.map(({ value, emoji }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              background: "linear-gradient(135deg, oklch(0.14 0.02 65 / 0.70), oklch(0.10 0.01 45))",
